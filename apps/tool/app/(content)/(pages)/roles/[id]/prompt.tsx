...
export default function Prompt(props: PromptProps) {
  ...
  return (
    <>
      ...
      <Dialog
        footer={
          <ButtonPrimary className="ml-auto" disabled={content.trim() === props.role.system?.content} onClick={onClose}>
            Save
          </ButtonPrimary>
        }
        onClose={onClose}
  ...
  function onClose() {
    ...
    if (content && (!props.role.system || content.trim() !== props.role.system.content)) {
